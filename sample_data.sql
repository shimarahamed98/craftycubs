...
insert into customers (id, name, phone, email, address, notes) values
  ('00000000-0000-0000-0000-000000000101', 'Mrs. Christy Gregory',   '+94 77 234 5678', 'christy.gregory@gmail.com',   '14, Park Road, Colombo 05',     'Recurring client — birthday parties'),
  ('00000000-0000-0000-0000-000000000102', 'Mr. Ashan Fernando',     '+94 71 876 5432', 'ashan.fernando@gmail.com',    '22B, Lotus Lane, Nugegoda',     'School event coordinator'),
  ('00000000-0000-0000-0000-000000000103', 'Ms. Nadeesha Perera',    '+94 76 345 9900', 'nadeesha.perera@yahoo.com',   '8, Hill Crescent, Kandy',       'Corporate workshop client'),
  ('00000000-0000-0000-0000-000000000104', 'Mrs. Dilani Jayasinghe', '+94 77 112 3344', 'dilani.j@gmail.com',          '3, Flower Road, Colombo 03',    'Pre-school partner'),
  ('00000000-0000-0000-0000-000000000105', 'Mr. Roshan Wickrama',    '+94 70 998 7766', 'roshan.w@hotmail.com',        '56, Sea Street, Dehiwala',      'Weekend workshop bookings')
...
('00000000-0000-0000-0000-000000000201', 'CC-345', '2026-01-14',
  '00000000-0000-0000-0000-000000000101', 'Mrs. Christy Gregory', '+94 77 234 5678', 'christy.gregory@gmail.com', '14, Park Road, Colombo 05',
...
('00000000-0000-0000-0000-000000000202', 'CC-346', '2026-01-28',
  '00000000-0000-0000-0000-000000000102', 'Mr. Ashan Fernando', '+94 71 876 5432', 'ashan.fernando@gmail.com', '22B, Lotus Lane, Nugegoda',
...
('00000000-0000-0000-0000-000000000203', 'CC-347', '2026-02-10',
  '00000000-0000-0000-0000-000000000103', 'Ms. Nadeesha Perera', '+94 76 345 9900', 'nadeesha.perera@yahoo.com', '8, Hill Crescent, Kandy',
...
('00000000-0000-0000-0000-000000000204', 'CC-348', '2026-02-22',
  '00000000-0000-0000-0000-000000000104', 'Mrs. Dilani Jayasinghe', '+94 77 112 3344', 'dilani.j@gmail.com', '3, Flower Road, Colombo 03',
...
-- CC-349 · Unpaid / Overdue (Mar)
('00000000-0000-0000-0000-000000000205', 'CC-349', '2026-03-05',
  '00000000-0000-0000-0000-000000000105', 'Mr. Roshan Wickrama', '+94 70 998 7766', 'roshan.w@hotmail.com', '56, Sea Street, Dehiwala',
...
('00000000-0000-0000-0000-000000000206', 'CC-350', '2026-04-18',
  '00000000-0000-0000-0000-000000000101', 'Mrs. Christy Gregory', '+94 77 234 5678', 'christy.gregory@gmail.com', '14, Park Road, Colombo 05',
...
('00000000-0000-0000-0000-000000000207', 'CC-351', '2026-05-30',
  '00000000-0000-0000-0000-000000000102', 'Mr. Ashan Fernando', '+94 71 876 5432', 'ashan.fernando@gmail.com', '22B, Lotus Lane, Nugegoda',
...
insert into payments (id, invoice_id, amount, note, method, created_at) values
  ('00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000201', 34000, '50% deposit received',        'bank', '2026-01-05 10:00:00+05:30'),
  ('00000000-0000-0000-0000-000000000302', '00000000-0000-0000-0000-000000000201', 34000, 'Balance cleared after event', 'bank', '2026-01-15 09:00:00+05:30'),
  ('00000000-0000-0000-0000-000000000303', '00000000-0000-0000-0000-000000000202', 56500, 'Full payment in advance',     'bank', '2026-01-25 11:00:00+05:30'),
  ('00000000-0000-0000-0000-000000000304', '00000000-0000-0000-0000-000000000203', 63175, '50% deposit — Kandy event',   'bank', '2026-02-01 14:00:00+05:30'),
  ('00000000-0000-0000-0000-000000000305', '00000000-0000-0000-0000-000000000204', 50500, 'Cash payment on the day',     'cash', '2026-02-22 12:00:00+05:30'),
  ('00000000-0000-0000-0000-000000000306', '00000000-0000-0000-0000-000000000207', 65250, '50% deposit received',        'bank', '2026-05-20 10:00:00+05:30')
on conflict (id) do nothing;

-- ── EVENTS ─────────────────────────────────────────────────
insert into events (id, name, date, customer_id, customer_name, invoice_id, total_expenses, notes) values
  ('00000000-0000-0000-0000-000000000401', 'Tote Bag Painting — British School',       '2026-01-14', '00000000-0000-0000-0000-000000000101', 'Mrs. Christy Gregory',   '00000000-0000-0000-0000-000000000201', 18500, 'Bags + glitter + staff × 2'),
  ('00000000-0000-0000-0000-000000000402', 'Art Day — Gateway College',                '2026-01-28', '00000000-0000-0000-0000-000000000102', 'Mr. Ashan Fernando',     '00000000-0000-0000-0000-000000000202', 22000, 'Canvases, paints, material packs for 60 students'),
  ('00000000-0000-0000-0000-000000000403', 'Corporate Craft — Cinnamon Grand',         '2026-02-10', '00000000-0000-0000-0000-000000000103', 'Ms. Nadeesha Perera',    '00000000-0000-0000-0000-000000000203', 41000, 'Premium materials + 3 staff'),
  ('00000000-0000-0000-0000-000000000404', 'Sensory Play — Little Wonders Montessori', '2026-02-22', '00000000-0000-0000-0000-000000000104', 'Mrs. Dilani Jayasinghe', '00000000-0000-0000-0000-000000000204', 14000, 'Sensory materials + parent pack'),
  ('00000000-0000-0000-0000-000000000405', 'Pottery Workshop — Dehiwala',              '2026-03-05', '00000000-0000-0000-0000-000000000105', 'Mr. Roshan Wickrama',    '00000000-0000-0000-0000-000000000205', 19500, 'Clay + kiln rental + staff'),
  ('00000000-0000-0000-0000-000000000406', 'Birthday Party — BMICH',                   '2026-04-18', '00000000-0000-0000-0000-000000000101', 'Mrs. Christy Gregory',   '00000000-0000-0000-0000-000000000206', 0,     'Upcoming — not happened yet'),
  ('00000000-0000-0000-0000-000000000407', 'End-of-Year Exhibition — Gateway College', '2026-05-30', '00000000-0000-0000-0000-000000000102', 'Mr. Ashan Fernando',     '00000000-0000-0000-0000-000000000207', 38000, 'Frames, display boards, printing')
on conflict (id) do nothing;

-- ── FINANCE ENTRIES ────────────────────────────────────────
insert into finance_entries (id, person, type, amount, note, month, year) values
  ('00000000-0000-0000-0000-000000000501', 'R', 'investment', 150000, 'Initial capital — Jan 2026',       1, 2026),
  ('00000000-0000-0000-0000-000000000502', 'T', 'investment', 150000, 'Initial capital — Jan 2026',       1, 2026),
  ('00000000-0000-0000-0000-000000000503', 'R', 'withdrawal', 45000,  'Profit share — Feb 2026',          2, 2026),
  ('00000000-0000-0000-0000-000000000504', 'T', 'withdrawal', 45000,  'Profit share — Feb 2026',          2, 2026),
  ('00000000-0000-0000-0000-000000000505', 'R', 'investment', 50000,  'Additional working capital — Mar', 3, 2026),
  ('00000000-0000-0000-0000-000000000506', 'R', 'withdrawal', 30000,  'Profit share — Apr 2026',          4, 2026),
  ('00000000-0000-0000-0000-000000000507', 'T', 'withdrawal', 30000,  'Profit share — Apr 2026',          4, 2026)
on conflict (id) do nothing;

-- ── INVOICE TEMPLATES ──────────────────────────────────────
insert into invoice_templates (id, name, data) values
  ('00000000-0000-0000-0000-000000000601', 'Tote Bag Package',
  ...
  ('00000000-0000-0000-0000-000000000602', 'Birthday Party Package',
  ...
  ('00000000-0000-0000-0000-000000000603', 'Corporate Workshop',
